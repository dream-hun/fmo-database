...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('global.create') }} {{ trans('cruds.toolkit.title_singular') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route("admin.toolkits.store") }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('identification_number') ? 'is-invalid' : '' }}" type="text" name="identification_number" id="identification_number" value="{{ old('identification_number', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('tvet_attended') ? 'is-invalid' : '' }}" type="text" name="tvet_attended" id="tvet_attended" value="{{ old('tvet_attended', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('training_intake') ? 'is-invalid' : '' }}" type="text" name="training_intake" id="training_intake" value="{{ old('training_intake', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('reception_date') ? 'is-invalid' : '' }}" type="text" name="reception_date" id="reception_date" value="{{ old('reception_date', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('toolkit_received') ? 'is-invalid' : '' }}" type="text" name="toolkit_received" id="toolkit_received" value="{{ old('toolkit_received', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('toolkit_cost') ? 'is-invalid' : '' }}" type="number" step="0.01" name="toolkit_cost" id="toolkit_cost" value="{{ old('toolkit_cost', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('subsidized_percent') ? 'is-invalid' : '' }}" type="number" step="0.01" name="subsidized_percent" id="subsidized_percent" value="{{ old('subsidized_percent', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('total') ? 'is-invalid' : '' }}" type="number" step="0.01" name="total" id="total" value="{{ old('total', '') }}">
                    @if($errors->has('total'))
