            ...
            <form method="POST" action="{{ route("admin.toolkits.store") }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label class="required"
                           for="business_name">{{ trans('cruds.toolkit.fields.business_name') }}</label>
                    <input class="form-control {{ $errors->has('business_name') ? 'is-invalid' : '' }}" type="text"
                           name="business_name" id="business_name" value="{{ old('business_name', '') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control date {{ $errors->has('cohort') ? 'is-invalid' : '' }}" type="text"
                           name="cohort" id="cohort" value="{{ old('cohort') }}" required>
