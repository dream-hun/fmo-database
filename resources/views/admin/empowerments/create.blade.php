        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.empowerments.store") }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('support') ? 'is-invalid' : '' }}" type="text" name="support" id="support" value="{{ old('support', '') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('supported_children') ? 'is-invalid' : '' }}" type="number" name="supported_children" id="supported_children" value="{{ old('supported_children', '') }}" step="1">
