    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.trainings.update", [$training->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('gender') ? 'is-invalid' : '' }}" name="gender" id="gender">
                    ...
                    @foreach(App\Models\Training::GENDER_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('gender', $training->gender) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('national') ? 'is-invalid' : '' }}" type="text" name="national" id="national" value="{{ old('national', $training->national) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('district') ? 'is-invalid' : '' }}" type="text" name="district" id="district" value="{{ old('district', $training->district) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sector') ? 'is-invalid' : '' }}" type="text" name="sector" id="sector" value="{{ old('sector', $training->sector) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telephone') ? 'is-invalid' : '' }}" type="text" name="telephone" id="telephone" value="{{ old('telephone', $training->telephone) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('training_given') ? 'is-invalid' : '' }}" type="text" name="training_given" id="training_given" value="{{ old('training_given', $training->training_given) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('institution') ? 'is-invalid' : '' }}" type="text" name="institution" id="institution" value="{{ old('institution', $training->institution) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('training_date') ? 'is-invalid' : '' }}" type="text" name="training_date" id="training_date" value="{{ old('training_date', $training->training_date) }}">
