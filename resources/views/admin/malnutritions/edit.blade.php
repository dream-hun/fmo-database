...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('global.edit') }} {{ trans('cruds.malnutrition.title_singular') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route("admin.malnutritions.update", [$malnutrition->id]) }}" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="form-group">
                    ...
                    <select class="form-control select2 {{ $errors->has('project') ? 'is-invalid' : '' }}" name="project_id" id="project_id">
                        @foreach($projects as $id => $entry)
                            <option value="{{ $id }}" {{ (old('project_id') ? old('project_id') : $malnutrition->project->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('surname') ? 'is-invalid' : '' }}" type="text" name="surname" id="surname" value="{{ old('surname', $malnutrition->surname) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('first_name') ? 'is-invalid' : '' }}" type="text" name="first_name" id="first_name" value="{{ old('first_name', $malnutrition->first_name) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('age') ? 'is-invalid' : '' }}" type="text" name="age" id="age" value="{{ old('age', $malnutrition->age) }}">
                    @if($errors->has('age'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('health_center') ? 'is-invalid' : '' }}" type="text" name="health_center" id="health_center" value="{{ old('health_center', $malnutrition->health_center) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('sector') ? 'is-invalid' : '' }}" type="text" name="sector" id="sector" value="{{ old('sector', $malnutrition->sector) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('cell') ? 'is-invalid' : '' }}" type="text" name="cell" id="cell" value="{{ old('cell', $malnutrition->cell) }}">
                    @if($errors->has('cell'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('village') ? 'is-invalid' : '' }}" type="text" name="village" id="village" value="{{ old('village', $malnutrition->village) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('father_name') ? 'is-invalid' : '' }}" type="text" name="father_name" id="father_name" value="{{ old('father_name', $malnutrition->father_name) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('mother_name') ? 'is-invalid' : '' }}" type="text" name="mother_name" id="mother_name" value="{{ old('mother_name', $malnutrition->mother_name) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('home_phone') ? 'is-invalid' : '' }}" type="text" name="home_phone" id="home_phone" value="{{ old('home_phone', $malnutrition->home_phone) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control date {{ $errors->has('package_reception_date') ? 'is-invalid' : '' }}" type="text" name="package_reception_date" id="package_reception_date" value="{{ old('package_reception_date', $malnutrition->package_reception_date) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('entry_muac') ? 'is-invalid' : '' }}" type="number" name="entry_muac" id="entry_muac" value="{{ old('entry_muac', $malnutrition->entry_muac) }}" step="1">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('currently_muac') ? 'is-invalid' : '' }}" type="number" name="currently_muac" id="currently_muac" value="{{ old('currently_muac', $malnutrition->currently_muac) }}" step="1">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('current_malnutrition_code') ? 'is-invalid' : '' }}" name="current_malnutrition_code" id="current_malnutrition_code">
                        ...
                        @foreach(App\Models\Malnutrition::CURRENT_MALNUTRITION_CODE_SELECT as $key => $label)
                            <option value="{{ $key }}" {{ old('current_malnutrition_code', $malnutrition->current_malnutrition_code) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
