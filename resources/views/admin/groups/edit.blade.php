            ...
            <form method="POST" action="{{ route("admin.groups.update", [$group->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('code') ? 'is-invalid' : '' }}" type="text" name="code"
                           id="code" value="{{ old('code', $group->code) }}" required>
                    @if($errors->has('code'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name"
                           id="name" value="{{ old('name', $group->name) }}" required>
                    @if($errors->has('name'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('representer') ? 'is-invalid' : '' }}" type="text"
                           name="representer" id="representer" value="{{ old('representer', $group->representer) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('representer_phone') ? 'is-invalid' : '' }}" type="text"
                           name="representer_phone" id="representer_phone"
                           value="{{ old('representer_phone', $group->representer_phone) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control date {{ $errors->has('mou_signed_at') ? 'is-invalid' : '' }}" type="text"
                           name="mou_signed_at" id="mou_signed_at"
                           value="{{ old('mou_signed_at', $group->mou_signed_at) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('number_of_members') ? 'is-invalid' : '' }}"
                           ...
                           value="{{ old('number_of_members', $group->number_of_members) }}" step="1">
