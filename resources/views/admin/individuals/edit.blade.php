        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.individuals.update", [$individual->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('id_number') ? 'is-invalid' : '' }}" type="text" name="id_number" id="id_number" value="{{ old('id_number', $individual->id_number) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('business_name') ? 'is-invalid' : '' }}" type="text" name="business_name" id="business_name" value="{{ old('business_name', $individual->business_name) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('telephone') ? 'is-invalid' : '' }}" type="text" name="telephone" id="telephone" value="{{ old('telephone', $individual->telephone) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('guardian') ? 'is-invalid' : '' }}" type="text" name="guardian" id="guardian" value="{{ old('guardian', $individual->guardian) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('guardian_phone') ? 'is-invalid' : '' }}" type="text" name="guardian_phone" id="guardian_phone" value="{{ old('guardian_phone', $individual->guardian_phone) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('sector') ? 'is-invalid' : '' }}" type="text" name="sector" id="sector" value="{{ old('sector', $individual->sector) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('cell') ? 'is-invalid' : '' }}" type="text" name="cell" id="cell" value="{{ old('cell', $individual->cell) }}">
                    @if($errors->has('cell'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('village') ? 'is-invalid' : '' }}" type="text" name="village" id="village" value="{{ old('village', $individual->village) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('loan_amount') ? 'is-invalid' : '' }}" type="number" name="loan_amount" id="loan_amount" value="{{ old('loan_amount', $individual->loan_amount) }}" step="1">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control date {{ $errors->has('loan_date') ? 'is-invalid' : '' }}" type="text" name="loan_date" id="loan_date" value="{{ old('loan_date', $individual->loan_date) }}" required>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('gender') ? 'is-invalid' : '' }}" name="gender" id="gender">
                        ...
                        @foreach(App\Models\Individual::GENDER_SELECT as $key => $label)
                            <option value="{{ $key }}" {{ old('gender', $individual->gender) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
