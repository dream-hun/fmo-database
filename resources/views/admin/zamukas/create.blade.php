...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('global.create') }} {{ trans('cruds.zamuka.title_singular') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route("admin.zamukas.store") }}" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('head_of_household_name') ? 'is-invalid' : '' }}"
                           ...
                           value="{{ old('head_of_household_name', '') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('spouse_id_number') ? 'is-invalid' : '' }}" type="text"
                           name="spouse_id_number" id="spouse_id_number" value="{{ old('spouse_id_number', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('house_hold_phone') ? 'is-invalid' : '' }}" type="text"
                           name="house_hold_phone" id="house_hold_phone" value="{{ old('house_hold_phone', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('family_size') ? 'is-invalid' : '' }}" type="number"
                           name="family_size" id="family_size" value="{{ old('family_size', '') }}" step="1">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('entrance_year') ? 'is-invalid' : '' }}" type="number"
                           name="entrance_year" id="entrance_year" value="{{ old('entrance_year', '') }}" step="1">
