...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('global.create') }} {{ trans('cruds.fruit.title_singular') }}
        </div>
        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.fruits.store") }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('mangoes') ? 'is-invalid' : '' }}" type="number" name="mangoes" id="mangoes" value="{{ old('mangoes', '') }}" step="1">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('avocado') ? 'is-invalid' : '' }}" type="number" name="avocado" id="avocado" value="{{ old('avocado', '') }}" step="1">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('papaya') ? 'is-invalid' : '' }}" type="number" name="papaya" id="papaya" value="{{ old('papaya', '') }}" step="1">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('oranges') ? 'is-invalid' : '' }}" type="number" name="oranges" id="oranges" value="{{ old('oranges', '') }}" step="1">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('distribution_date') ? 'is-invalid' : '' }}" type="text" name="distribution_date" id="distribution_date" value="{{ old('distribution_date', '') }}">
