...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('global.edit') }} {{ trans('cruds.musa.title_singular') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route("admin.musas.update", [$musa->id]) }}" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="form-group">
                    <label class="required" for="name">{{ trans('cruds.musa.fields.name') }}</label>
                    <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $musa->name) }}" required>
                    @if($errors->has('name'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('id_number') ? 'is-invalid' : '' }}" type="text" name="id_number" id="id_number" value="{{ old('id_number', $musa->id_number) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('family_members') ? 'is-invalid' : '' }}" type="number" name="family_members" id="family_members" value="{{ old('family_members', $musa->family_members) }}" step="1">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('support_given') ? 'is-invalid' : '' }}" type="number" name="support_given" id="support_given" value="{{ old('support_given', $musa->support_given) }}" step="1">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control date {{ $errors->has('support_date') ? 'is-invalid' : '' }}" type="text" name="support_date" id="support_date" value="{{ old('support_date', $musa->support_date) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('sector') ? 'is-invalid' : '' }}" type="text" name="sector" id="sector" value="{{ old('sector', $musa->sector) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('cell') ? 'is-invalid' : '' }}" type="text" name="cell" id="cell" value="{{ old('cell', $musa->cell) }}">
                    @if($errors->has('cell'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('village') ? 'is-invalid' : '' }}" type="text" name="village" id="village" value="{{ old('village', $musa->village) }}">
