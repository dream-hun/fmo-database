...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('global.create') }} {{ trans('cruds.mvtc.title_singular') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route("admin.mvtcs.store") }}" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    <label for="reg_no">{{ trans('cruds.mvtc.fields.reg_no') }}</label>
                    <input class="form-control {{ $errors->has('reg_no') ? 'is-invalid' : '' }}" type="text" name="reg_no" id="reg_no" value="{{ old('reg_no', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('student_contact') ? 'is-invalid' : '' }}" type="text" name="student_contact" id="student_contact" value="{{ old('student_contact', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('trade') ? 'is-invalid' : '' }}" type="text" name="trade" id="trade" value="{{ old('trade', '') }}">
                    @if($errors->has('trade'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('resident_district') ? 'is-invalid' : '' }}" type="text" name="resident_district" id="resident_district" value="{{ old('resident_district', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('payment_mode') ? 'is-invalid' : '' }}" type="text" name="payment_mode" id="payment_mode" value="{{ old('payment_mode', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('graduation_date') ? 'is-invalid' : '' }}" type="text" name="graduation_date" id="graduation_date" value="{{ old('graduation_date', '') }}">
