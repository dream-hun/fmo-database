...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('global.edit') }} {{ trans('cruds.urgent.title_singular') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route("admin.urgents.update", [$urgent->id]) }}" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="form-group">
                    <label class="required" for="name">{{ trans('cruds.urgent.fields.name') }}</label>
                    <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $urgent->name) }}" required>
                    @if($errors->has('name'))
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('gender') ? 'is-invalid' : '' }}" name="gender" id="gender" required>
                        ...
                        @foreach(App\Models\Urgent::GENDER_SELECT as $key => $label)
                            <option value="{{ $key }}" {{ old('gender', $urgent->gender) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('id_number') ? 'is-invalid' : '' }}" type="text" name="id_number" id="id_number" value="{{ old('id_number', $urgent->id_number) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('sector') ? 'is-invalid' : '' }}" type="text" name="sector" id="sector" value="{{ old('sector', $urgent->sector) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('cell') ? 'is-invalid' : '' }}" type="text" name="cell" id="cell" value="{{ old('cell', $urgent->cell) }}">
                    @if($errors->has('cell'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('village') ? 'is-invalid' : '' }}" type="text" name="village" id="village" value="{{ old('village', $urgent->village) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('phone_number') ? 'is-invalid' : '' }}" type="text" name="phone_number" id="phone_number" value="{{ old('phone_number', $urgent->phone_number) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('support') ? 'is-invalid' : '' }}" type="text" name="support" id="support" value="{{ old('support', $urgent->support) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control date {{ $errors->has('support_date') ? 'is-invalid' : '' }}" type="text" name="support_date" id="support_date" value="{{ old('support_date', $urgent->support_date) }}" required>
