...
@section('content')
    <div class="card">
        <div class="card-header">
            {{ trans('global.create') }} {{ trans('cruds.girinka.title_singular') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route('admin.girinkas.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('names') ? 'is-invalid' : '' }}" type="text" name="names"
                        id="names" value="{{ old('names', '') }}" required>
                    @if ($errors->has('names'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('id_number') ? 'is-invalid' : '' }}" type="number"
                        name="id_number" id="id_number" value="{{ old('id_number', '') }}" step="1">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('cell') ? 'is-invalid' : '' }}" type="text"
                        name="cell" id="cell" value="{{ old('cell', '') }}">
                    @if ($errors->has('cell'))
                        <div class="invalid-feedback">
                            {{ $errors->first('cell') }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('m_status') ? 'is-invalid' : '' }}" type="text"
                        name="m_status" id="m_status" value="{{ old('m_status', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('pass_over') ? 'is-invalid' : '' }}" type="text"
                        name="pass_over" id="pass_over" value="{{ old('pass_over', '') }}">
